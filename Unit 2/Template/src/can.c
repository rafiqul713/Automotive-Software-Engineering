 ...
 ********************************************************************/
    ...
    //Message buffer Code
    // 4 bit field part of the message buffer matching 
    //and arbitration process
    CAN_0.BUF[0].CS.B.CODE = 0b1100; //Transmit remote frame unconditionally
    /* Standard format */
    ...
    //CAN_0.BUF[0].CS.B.SRR = ; //Used only Extended Frame
    
    //Remote Transmission Request. Used for requesting of 
    //transmission of a Data Frame
    // 0 means Data Frame to be transmitted.
    // 1 means Remote Frame to be transmitted.
    CAN_0.BUF[0].CS.B.RTR = 0; // Transmit Data Frame 
    /* Data Length */
    // Sending 4 byte Data
    CAN_0.BUF[0].CS.B.LENGTH = 4; 
    /* STD_ID */
    //CAN_0.BUF[0].ID.B.STD_ID = ; // Last 3 digit of IP address
 ...
 ********************************************************************/
    ...
    CAN_0.RXFIFO.IDTABLE[0].R = 0x40FFFFF;
    CAN_0.RXIMR[0].R = 0x78FFFFF;
