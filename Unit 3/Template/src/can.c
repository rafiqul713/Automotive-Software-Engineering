 ...
 ********************************************************************/
    ...
    /* STD_ID */
    CAN_0.BUF[0].ID.B.STD_ID = 0x401; /* fuel level message id */
    ...
    /* STD_ID */
    CAN_0.BUF[1].ID.B.STD_ID =  0x402; /* indicator switches message id */
    ...
    /* STD_ID */
    CAN_0.BUF[2].ID.B.STD_ID = 0x403; /* door status-warning message id */
    ...
    /* STD_ID */
    CAN_0.BUF[3].ID.B.STD_ID = 0x404; /* alive message id */
    ...
    /* STD_ID */
    CAN_0.BUF[4].ID.B.STD_ID = 0x405; /* error message id */
